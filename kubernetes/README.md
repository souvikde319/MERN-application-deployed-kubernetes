...
```bash
docker build -t techsj04/frontend-wanderlust:v2.1.8 .
```
...
```bash
docker build -t techsj04/backend-wanderlust:v2.1.8 .
```
...
```bash
docker push techsj04/frontend-wanderlust:v2.1.8
docker push techsj04/backend-wanderlust:v2.1.8
```
